...
Результативный \textbf{Senior Go Software Engineer} с опытом более 4 лет в проектировании и масштабировании облачных платформ, высокодоступных микросервисов и event-driven систем в финтехе и корпоративном сегменте. Достиг сокращения уязвимостей на \textbf{89\%} (устранены все критические), увеличения покрытия тестами на \textbf{10\%} в кодовой базе объемом более 20k LOC, а также реализации API с нагрузкой 10k+ RPS и \textbf{uptime 99.9\%}. Опыт в согласовании архитектуры между командами, наставничестве и модернизации систем с глубокими знаниями Go, Kubernetes, gRPC, Kafka и PostgreSQL.
...
\cvitem{Облако/DevOps}{Kubernetes, Docker, AWS, GCP, ArgoCD, GitHub Actions, CI/CD}
...
\cvitem{Мониторинг}{Grafana, Loki, Prometheus; инцидент-менеджмент, L3 поддержка}

% --- Опыт работы ---
\section{Опыт работы}

\cventry{Янв 2025 -- наст. время}{Senior Go Software Engineer}{EPAM}{Астана, Казахстан}{}{
\begin{itemize}
  \item Руководил командой из 3 инженеров при модернизации платформы Node/Angular, сократил уязвимости с \textbf{228 (28 критических)} до \textbf{26 (0 критических)}.
  \item Увеличил автоматическое покрытие тестами на \textbf{10\%} в кодовой базе \textbf{20k+ LOC}.
  \item Спроектировал и реализовал масштабируемый \textbf{сервис многоуровневых уведомлений} (in-app, email, SMS).
  \item Создал \textbf{Kubernetes операторов} для стандартизации деплойментов и rollout конфигураций.
  \item Организовал сессии проектирования между командами для согласования API и архитектурных стандартов.
